...
class EnhancedEcommerceService
{
    ...
    public function getNavigationTags($navigationId, $listing, SalesChannelContext $context) {
        ...
        //Impressions
        $enhanced_ecom_tags['impressions'] = $this->getImpressions($listing, $eeMaxAmountCategoriesForImpressions, 'Category', $category->getTranslation('name'));
    ...
    public function getSearchTags($searchTerm, ProductListingResult $listing, SalesChannelContext $context) {
        ...
        //Impressions
        $enhanced_ecom_tags['impressions'] = $this->getImpressions($listing->getEntities(), $eeMaxAmountCategoriesForImpressions, 'Search', '');
